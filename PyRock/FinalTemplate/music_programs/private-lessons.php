		...
		<header id="home" class="jumbotron">
			<div class="container" style="background-image: url('../images/drum-lessons.jpg');width: 100%;height: 100%;">			
				<div class="message-box clearfix">
					<div class="row">
						<div class="col-md-7">
							<h1 class = "lessonsmaintitle" id="lessonsmaintitleh1">Private<br>Lessons</h1>
							<h2 class = "lessonsmaintitle" id="lessonsmaintitleh2">A Beginning</h2>
						</div>
						<div class="col-md-5">
...
?>
							...
							<!-- Test Form-->
							<div>						
								<form class="freelessonform" form action="private-lessons.php" method="post">
		...
		<div class="sectiondivider">
			<div class="row">
				<div class="col-md-12 ourprogramsinstruments">
					...
					<button type="button" class="btn ourprogramsbutton ourprogramsselector"><a href="../music_programs/private-lessons.php">Private Lessons</a></button>
					...
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Learn the<br>Basics</h1>
								<p class ="ourprograms">
									Not everyone is comfortable learning in a group environment,<br>
									but that is ok! At PY Rock we offer private lessons that are perfect<br>
									for beginner musicians, or for students who wish for more attention from<br> 
									their teacher. With enough care and work from the student, it is possible for<br>
									them to reach a higher level program quickly!
									<br>
									<br>
			...
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Beginner<br>Friendly</h1>
								<p class ="ourprograms">
									In our Private Lessons Program, students will work in a one-on-one<br>
									environment with the same teacher each lesson. These sessions are generally<br>
									shorter than our other programs, due to the intensity of each session, and preventing<br> 
									overwork on the student's part. They are beginners afterall!
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Sign Up Today!</h2></button>
								</p>
