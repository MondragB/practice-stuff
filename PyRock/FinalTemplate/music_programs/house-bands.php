		...
		<header id="home" class="jumbotron">
			<div class="container" style="background-image: url('../images/drum-lessons.jpg');width: 100%;height: 100%;">			
				<div class="message-box clearfix">
					<div class="row">
						<div class="col-md-7">
							<h1 class = "lessonsmaintitle" id="lessonsmaintitleh1">House<br>Bands</h1>
							<h2 class = "lessonsmaintitle" id="lessonsmaintitleh2">Move Beyond</h2>
						</div>
						<div class="col-md-5">
...
?>
							...
							<!-- Test Form-->
							<div>						
								<form class="freelessonform" form action="house-bands.php" method="post">
		...
		<div class="sectiondivider">
			<div class="row">
				<div class="col-md-12 ourprogramsinstruments">
					...
					<button type="button" class="btn ourprogramsbutton ourprogramsselector"><a href="../music_programs/house-bands.php">House Bands</a></button>
					...
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Be The<br>Best</h1>
								<p class ="ourprograms">
									Upon completion of the Pre-Rock and Rock Band Programs, our students<br>
									are given the oppurtunity to audition for a part in one of our house bands.<br>
									Similarly to our Rock Band Program, these bands will tour venues, but at a<br> 
									higher level and at many different and distant locations. If you want to be the<br>
									best of the best, this is the program for you!
									<br>
									<br>
