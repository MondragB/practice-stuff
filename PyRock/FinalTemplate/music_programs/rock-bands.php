		...
		<header id="home" class="jumbotron">
			<div class="container" style="background-image: url('../images/drum-lessons.jpg');width: 100%;height: 100%;">			
				<div class="message-box clearfix">
					<div class="row">
						<div class="col-md-7">
							<h1 class = "lessonsmaintitle" id="lessonsmaintitleh1">Rock <br>Bands</h1>
							<h2 class = "lessonsmaintitle" id="lessonsmaintitleh2">Live The Dream</h2>
						</div>
						<div class="col-md-5">
...
?>
							<!-- Test Form-->
							<div>						
								<form class="freelessonform" form action="rock-bands.php" method="post">
		...
		<div class="sectiondivider">
			<div class="row">
				<div class="col-md-12 ourprogramsinstruments">
					<p>
					<button type="button" class="btn ourprogramsbutton ourprogramsselector"><a href="../music_programs/rock-bands.php">Rock Bands</a></button>
					...
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Be a Star</h1>
								<p class ="ourprograms">
									After auditioning and showing they have what it takes to be<br>
									a band, our students are placed into their own rock band.<br>
									These band members work closely with our professional band coaches<br> 
									to work towards performing at live shows!
									<br>
									<br>
			...
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Do You Have<br>What It Takes?</h1>
								<p class ="ourprograms">
									Our Rock Band Program meets once a week for 90 minutes in <br>
									order to practice the songs the band plans on playing for<br>
									a live audience. Once they are ready, our students will perform live<br> 
									at local venues for live audiences. It's the beginning of a long road<br>
									to becoming a hit band!
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Sign Up Today!</h2></button>
								</p>
