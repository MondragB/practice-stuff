		...
		<header id="home" class="jumbotron">
			<div class="container" style="background-image: url('../images/drum-lessons.jpg');width: 100%;height: 100%;">			
				<div class="message-box clearfix">
					<div class="row">
						<div class="col-md-7">
							<h1 class = "lessonsmaintitle" id="lessonsmaintitleh1">Pre-Rock <br>Bands</h1>
							<h2 class = "lessonsmaintitle" id="lessonsmaintitleh2">A Learning Experience</h2>
						</div>
						<div class="col-md-5">
...
?>
							...
							<!-- Test Form-->
							<div>						
								<form class="freelessonform" form action="pre-rock-bands.php" method="post">
		...
		<div class="sectiondivider">
			<div class="row">
				<div class="col-md-12 ourprogramsinstruments">
					...
					<button type="button" class="btn ourprogramsbutton ourprogramsselector"><a href="../music_programs/pre-rock-bands.php">Pre-Rock Bands</a></button>
					...
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Be An Up <br> And Comer</h1>
								<p class ="ourprograms">
									Not everyone who enrolls at PY Rock is ready for the stage.<br>
									However, we aim to change that. Our Pre-Rock Band program<br>
									aims to help our newest students overcome their fears and learn<br> 
									to perform, with the potential of joining a real band<br>
			...
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Join The<br>Team</h1>
								<p class ="ourprograms">
									Our Pre-Rock Program meets once a week for 60 minutes, and<br>
									works with our student's individual needs.<br>
									They will also have the oppurtunity to perform in front of<br> 
									their fellow classmates in order to slowly ease them into what it<br>
									is really like to be in a Rock Band!
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Sign Up Today!</h2></button>
								</p>
