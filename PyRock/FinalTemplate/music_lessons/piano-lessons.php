<?php include 'includes/header.php';?>
		...
		<header id="home" class="jumbotron">
			<div class="container" style="background-image: url('../images/piano-lessons.jpg');width: 100%;height: 100%;">			
				<div class="message-box clearfix">
					<div class="row">
						<div class="col-md-7">
							<h1 class = "lessonsmaintitle" id="lessonsmaintitleh1">Piano <br>Lessons</h1>
							<h2 class = "lessonsmaintitle" id="lessonsmaintitleh2">Black and White Greatness</h2>
						</div>
						<div class="col-md-5">
...
?>
							...
							<!-- Test Form-->
						<div>						
								<form class="freelessonform" form action="piano-lessons.php" method="post">
		...
		<div class="sectiondivider">
			<div class="row">
				<div class="col-md-12 ourprogramsinstruments">
					<p>
					<button type="button" class="btn ourprogramsbutton ourprogramsselector"><a href="../music_lessons/piano-lessons.php">Piano</a></button>
				...
				<div class="col-md-4">
					<h1 class="ourprogramssectiontitle">All Ages </h1>
				</div>
				<div class="col-md-4">
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Piano Lessons <br> For Kids</h1>
								<p class ="ourprograms">
		...
		<!-- ==============================================
		ALL LEVELS
		PIANO LESSONS FOR BEGINNERS SECTION
		=============================================== -->		
		<section id="about">
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer">
								<h1 class="ourprograms">Piano Lessons <br> For Beginner Students</h1>
								<p class ="ourprograms">
									Piano Beginner Placeholder
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Learn More..</h2></button>
								</p>
		...
		<!-- ==============================================
		PIANO LESSONS FOR INTERMEDIATE SECTION
		=============================================== -->		
		<section id="about">
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Piano Lessons <br> For Intermediate Students</h1>
								<p class ="ourprograms">
									Piano Intermediate Placeholder
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Learn More..</h2></button>
								</p>
		...
		<!-- ==============================================
		PIANO LESSONS FOR ADVANCED SECTION
		=============================================== -->		
		<section id="about">
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer">
								<h1 class="ourprograms">Piano Lessons <br> For Advanced Students</h1>
								<p class ="ourprograms">
									Piano Advanced Placeholder
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Learn More..</h2></button>
								</p>
