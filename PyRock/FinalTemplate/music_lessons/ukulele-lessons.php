<?php include 'includes/header.php';?>
		...
		<header id="home" class="jumbotron">
			<div class="container" style="background-image: url('../images/ukulele-lessons.jpg');width: 100%;height: 100%;">			
				<div class="message-box clearfix">
					<div class="row">
						<div class="col-md-7">
							<h1 class = "lessonsmaintitle" id="lessonsmaintitleh1">Ukulele <br>Lessons</h1>
							<h2 class = "lessonsmaintitle" id="lessonsmaintitleh2">Somewhere Over the Rainbow</h2>
						</div>
						<div class="col-md-5">
...
?>
							<!-- Test Form-->
							<div>						
								<form class="freelessonform" form action="ukulele-lessons.php" method="post">
		...
		<div class="sectiondivider">
			<div class="row">
				<div class="col-md-12 ourprogramsinstruments">
					...
					<button type="button" class="btn ourprogramsbutton ourprogramsselector"><a href="../music_lessons/ukulele-lessons.php">Ukulele</a></button>
		...
		<!-- ==============================================
		UKULELE LESSONS FOR KIDS SECTION
		=============================================== -->		
		<section id="about">
					...
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Ukulele Guitar Lessons <br> For Kids</h1>
								<p class ="ourprograms">
									Ukulele kids placeholder
									<br>
									<br>
		...
		<!-- ==============================================
		UKULELE LESSONS FOR TEENS SECTION
		=============================================== -->		
		<section id="about">
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer">
								<h1 class="ourprograms">Ukulele Lessons <br> For Teens</h1>
								<p class ="ourprograms">
									Ukulele teens placeholder
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Learn More..</h2></button>
								</p>
		...
		<!-- ==============================================
		UKULELE LESSONS FOR ADULTS SECTION
		=============================================== -->		
		<section id="about">
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Ukulele Lessons <br> For Adults</h1>
								<p class ="ourprograms">
									Ukulele Adults Placeholder
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Learn More..</h2></button>
								</p>
...
<!-- ==============================================
	...
	<!-- ==============================================
		ALL LEVELS
		UKULELE LESSONS FOR BEGINNERS SECTION
		=============================================== -->		
		<section id="about">
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer">
								<h1 class="ourprograms">Ukulele Lessons <br> For Beginner Students</h1>
								<p class ="ourprograms">
									Ukulele Beginners Placeholder
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Learn More..</h2></button>
								</p>
		...
		<!-- ==============================================
		UKULELE LESSONS FOR INTERMEDIATE SECTION
		=============================================== -->		
		<section id="about">
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Ukulele Lessons <br> For Intermediate Students</h1>
								<p class ="ourprograms">
									Ukulele Intermediate Placeholder
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Learn More..</h2></button>
								</p>
		...
		<!-- ==============================================
		UKULELE LESSONS FOR ADVANCED SECTION
		=============================================== -->		
		<section id="about">
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer">
								<h1 class="ourprograms">Ukulele Lessons <br> For Advanced Students</h1>
								<p class ="ourprograms">
									Ukulele Advanced Placeholder
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Learn More..</h2></button>
								</p>
