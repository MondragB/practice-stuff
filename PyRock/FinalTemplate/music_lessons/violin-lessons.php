<?php include 'includes/header.php';?>
		...
		<header id="home" class="jumbotron">
			<div class="container" style="background-image: url('../images/violin-lessons.jpg');width: 100%;height: 100%;">			
				<div class="message-box clearfix">
					<div class="row">
						<div class="col-md-7">
							<h1 class = "lessonsmaintitle" id="lessonsmaintitleh1">Violin <br>Lessons</h1>
							<h2 class = "lessonsmaintitle" id="lessonsmaintitleh2">The beauty of sadness</h2>
						</div>
						<div class="col-md-5">
						<?php
...
?>
							...
							<!-- Test Form-->
							<div>						
								<form class="freelessonform" form action="violin-lessons.php" method="post">
		...
		<div class="sectiondivider">
			<div class="row">
				<div class="col-md-12 ourprogramsinstruments">
					...
					<button type="button" class="btn ourprogramsbutton ourprogramsselector"><a href="../music_lessons/violin-lessons.php">Violin</a></button>					
					</p>
				</div>
				<div class="col-md-4">
				</div>
		...
		<!-- ==============================================
		VIOLIN LESSONS FOR KIDS SECTION
		=============================================== -->		
		<section id="about">
					...
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Violin Lessons <br> For Kids</h1>
								<p class ="ourprograms">
									Violin Kids Placeholder
									<br>
									<br>
		...
		<!-- ==============================================
		VIOLIN LESSONS FOR TEENS SECTION
		=============================================== -->		
		<section id="about">
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer">
								<h1 class="ourprograms">Violin Lessons <br> For Teens</h1>
								<p class ="ourprograms">
									Violin Teens Placeholder
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Learn More..</h2></button>
								</p>
		...
		<!-- ==============================================
		VIOLIN LESSONS FOR ADULTS SECTION
		=============================================== -->		
		<section id="about">
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Violin Lessons <br> For Adults</h1>
								<p class ="ourprograms">
									Violin Adults Placeholder
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Learn More..</h2></button>
								</p>
...
<!-- ==============================================
	...
	<!-- ==============================================
		ALL LEVELS
		VIOLIN LESSONS FOR BEGINNERS SECTION
		=============================================== -->		
		<section id="about">
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer">
								<h1 class="ourprograms">Violin Lessons <br> For Beginner Students</h1>
								<p class ="ourprograms">
									Violing Beginner Placeholder
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Learn More..</h2></button>
								</p>
		...
		<!-- ==============================================
		VIOLIN LESSONS FOR INTERMEDIATE SECTION
		=============================================== -->		
		<section id="about">
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer ourprogramsline">
								<h1 class="ourprograms">Violin Lessons <br> For Intermediate Students</h1>
								<p class ="ourprograms">
									Violin Intermediate Placeholder
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Learn More..</h2></button>
								</p>
		...
		<!-- ==============================================
		VIOLIN LESSONS FOR ADVANCED SECTION
		=============================================== -->		
		<section id="about">
			<div class="container-ourlessons" ">
				<div class="" style="margin-top: 10px;">
					<div class="row">
						...
						<div class="col-md-5">
							<div class="ourprogramscontainer">
								<h1 class="ourprograms">Violin Lessons <br> For Advanced Students</h1>
								<p class ="ourprograms">
									Violin Advanced Placeholder
									<br>
									<br>
									<button type="button" class="btn btn-secondary" style="width:200px;"><h2>Learn More..</h2></button>
								</p>
